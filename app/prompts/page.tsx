...
const TAB_OVERLAPS = {
  ...
  responded: { // Overlaps for RESPONDED tab
    active: {
      ...
      afterInactiveCreated: '-2px'
    },
    inactive: {
      afterActiveCreated: '-8px',
      afterInactiveCreated: '-15px'
    }
  }
} as const
      ...
      <div className="min-h-screen border-viewport border-[#B02A15] relative">
        <div className="max-w-2xl mx-auto p-4">
          <div className="p-8">
            ...
            <div className="flex items-end my-8 mb-0 relative -mx-4">
              {(['all', 'created', 'responded'] as const).map((tab, index) => {
                ...
                const getOverlap = () => {
                  if (index === 0) return '-4px'; // ALL tab alignment
            ...
            <div className="bg-[#FFEDD4] rounded-lg overflow-hidden border-t-8 border-t-[#F2A948] rounded-tl-[3px] rounded-tr-[3px] -mx-8 space-y-0 mt-0 relative -top-2 z-10">
                      ...
                      <div className="flex items-end justify-between">
                        ...
                        <div className="flex gap-2">
                          {prompt.status === 'ended' ? (
                            <button 
                              className={cn(
                                "px-4 py-1 rounded-full text-xl uppercase tracking-wider",
                                txcPearl.className,
                          ...
                          <button className={cn(
                            "px-4 py-1 bg-transparent text-[#B02A15] rounded-full",
        ...
        <div className="max-w-2xl mx-auto px-4 mb-12 mt-0">
          <Link 
            href="/instructions" 
            className={cn(
